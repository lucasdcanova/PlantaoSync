...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="text-brand-600 inline-flex items-center gap-1.5 rounded-full border border-brand-200/60 bg-brand-50/80 px-3 py-1 text-xs font-semibold uppercase tracking-widest dark:border-brand-800/60 dark:bg-brand-950/40 dark:text-brand-400">
      {children}
    </span>
  )
}
...
function FeatureCard({
  ...
  return (
    <motion.div
      ...
      className="card-base group p-6 transition-all duration-200 hover:shadow-elevated"
    >
      <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brand-100 text-brand-600 group-hover:bg-brand-600 group-hover:text-white dark:bg-brand-950/60 dark:text-brand-400 dark:group-hover:bg-brand-600 dark:group-hover:text-white transition-colors duration-200">
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        highlighted
          ? 'bg-brand-700 text-white shadow-brand ring-2 ring-brand-600'
          : 'card-base'
      )}
    >
      {highlighted && (
      ...
      <div>
        ...
        <div className="mt-3 flex items-end gap-1">
          ...
          <span className={cn('mb-1 text-sm', highlighted ? 'text-brand-200' : 'text-muted-foreground')}>
            /mês
          </span>
        </div>
        <p className={cn('mt-2 text-sm', highlighted ? 'text-brand-100/80' : 'text-muted-foreground')}>
          {description}
        </p>
      </div>
        ...
        {[
          ...
          <div key={item.label}>
            ...
            <p
              className={cn(
                'text-xs',
                highlighted ? 'text-brand-200' : 'text-muted-foreground'
              )}
            >
              {item.label}
            </p>
        ...
        {features.map((feat) => (
          <li key={feat} className="flex items-start gap-2.5">
            ...
            <span
              className={cn(
                'text-sm',
                highlighted ? 'text-brand-100/90' : 'text-muted-foreground'
              )}
            >
              {feat}
            </span>
      ...
      <Button
        className={cn(
          ...
          highlighted
            ...
            : 'bg-brand-700 text-white hover:bg-brand-800 shadow-brand'
        )}
        asChild
      >
    ...
    >
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <p className="border-border/60 border-t px-5 pb-5 pt-4 text-sm leading-relaxed text-muted-foreground">
              {answer}
            </p>
          </motion.div>
        )}
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <main>
        ...
        <section className="border-border/60 border-y bg-muted/30 px-4 py-14 sm:px-6">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
              {[
                ...
                >
                  <stat.icon className="text-brand-600 mx-auto mb-2 h-5 w-5 dark:text-brand-400" />
          ...
          <div className="mx-auto max-w-5xl">
            <motion.div {...fadeUp} transition={{ duration: 0.4 }} className="mb-16 text-center">
              ...
              <h2 className="font-display text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                WhatsApp e planilha têm um custo<br className="hidden sm:block" /> que não aparece no relatório
              </h2>
              <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-base leading-relaxed">
                73% dos hospitais brasileiros ainda gerenciam escalas de plantão por grupos de mensagem e planilhas compartilhadas. O resultado: horas perdidas, cobertura imprevisível e decisões sem rastreabilidade.
              </p>
            </motion.div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                >
                  ...
                  <div>
                    <h3 className="font-display text-foreground text-sm font-semibold">{item.title}</h3>
          ...
          <div className="mx-auto max-w-5xl">
            <motion.div {...fadeUp} transition={{ duration: 0.4 }} className="mb-16 text-center">
              ...
              <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-base">
                Cada perfil enxerga o que precisa. Todos trabalham na mesma informação, em tempo real.
              </p>
            </motion.div>
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {[
                ...
                >
                  <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-brand-100 text-brand-600 dark:bg-brand-950/60 dark:text-brand-400">
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mb-24 grid items-center gap-12 lg:grid-cols-2">
              <motion.div {...fadeUp} transition={{ duration: 0.4 }}>
                ...
                <h2 className="font-display text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                  O médico confirma em 1 toque.<br /> Você sabe na hora.
                </h2>
                <p className="text-muted-foreground mt-4 text-base leading-relaxed">
                  Chega de ligar, mandar áudio no WhatsApp e torcer para a mensagem ser vista. O CONFIRMA PLANTÃO notifica o profissional, recebe a confirmação e atualiza o dashboard — tudo em menos de dois minutos.
                </p>
              ...
              >
                <div className="rounded-xl bg-muted/60 p-5 dark:bg-muted/30">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-2">
                    ...
                    <div className="flex items-center justify-center rounded-xl border border-border bg-background py-2.5 text-sm font-medium text-muted-foreground">
                      Recusar
                    </div>
                  </div>
            ...
            <div className="mb-24 grid items-center gap-12 lg:grid-cols-2">
              ...
              >
                <div className="rounded-xl bg-muted/60 p-4 dark:bg-muted/30">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      { turno: 'Pronto-Socorro — Ter', confirmados: 2, total: 3, cor: 'bg-yellow-400' },
                      { turno: 'UTI Pediátrica — Qua', confirmados: 1, total: 2, cor: 'bg-yellow-400' },
              ...
              <motion.div {...fadeUp} transition={{ duration: 0.4 }} className="lg:order-2">
                ...
                <h2 className="font-display text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                  Veja lacunas antes que<br /> virem crises assistenciais.
                </h2>
                <p className="text-muted-foreground mt-4 text-base leading-relaxed">
                  O dashboard mostra o status de cobertura de cada turno por setor, especialidade e unidade. Quando um plantão está em risco, você recebe o alerta — não descobre quando o médico não aparece.
                </p>
                <ul className="mt-6 flex flex-col gap-3">
                  {[
            ...
            <div className="mb-24 grid items-center gap-12 lg:grid-cols-2">
              <motion.div {...fadeUp} transition={{ duration: 0.4 }}>
                ...
                <h2 className="font-display text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                  Custo de plantão calculado.<br /> Sem planilha extra.
                </h2>
                <p className="text-muted-foreground mt-4 text-base leading-relaxed">
                  Configure o valor por turno, especialidade e setor. O sistema acumula automaticamente por profissional e mês. No fechamento, os relatórios já estão prontos para pagamento — sem cruzamento manual de dados.
                </p>
                <ul className="mt-6 flex flex-col gap-3">
                  {[
              ...
              >
                <div className="rounded-xl bg-muted/60 p-4 dark:bg-muted/30">
                    ...
                    {[
                      ...
                      <div key={row.medico} className="flex items-center justify-between text-sm">
                        <div>
                          ...
                          <p className="text-muted-foreground text-xs">{row.plantoes} plantões confirmados</p>
                        </div>
                  ...
                  <div className="border-border mt-4 flex items-center justify-between border-t pt-3 text-sm">
                    ...
                    <span className="font-display text-foreground text-lg font-bold">R$ 46.800</span>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section id="como-funciona" className="bg-muted/30 px-4 py-24 sm:px-6">
          <div className="mx-auto max-w-4xl">
            <motion.div {...fadeUp} transition={{ duration: 0.4 }} className="mb-16 text-center">
              ...
              <h2 className="font-display text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                Da planilha para o controle total.<br /> Em 5 passos.
              </h2>
              <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-base">
            ...
            <div className="relative">
              <div className="absolute left-5 top-6 hidden h-[calc(100%-3rem)] w-px bg-border sm:block lg:left-1/2" />
              ...
              <div className="space-y-10">
                {[
                  ...
                  >
                    ...
                    >
                      <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-brand-600 bg-background text-xs font-bold text-brand-600 sm:mx-auto lg:mx-0">
                        {step.step}
                      </div>
                    ...
                    <div className="hidden lg:col-start-2 lg:flex lg:justify-center lg:pt-1">
                      <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-brand-600 bg-background text-xs font-bold text-brand-600">
                        {step.step}
                      </div>
                    </div>
                  </motion.div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <motion.div {...fadeUp} transition={{ duration: 0.4 }}>
                ...
                <h2 className="font-display text-foreground mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                  Dados de saúde merecem<br /> proteção de saúde.
                </h2>
                <p className="text-muted-foreground mt-4 text-base leading-relaxed">
                  A gestão de escalas envolve dados sensíveis de profissionais e pacientes. Cada camada do CONFIRMA PLANTÃO foi construída com segurança, privacidade e conformidade regulatória como prioridade — não como afterthought.
                </p>
                <div className="mt-8 space-y-4">
                  {[
                    ...
                    <div key={item.title} className="flex gap-4">
                      <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-brand-50 text-brand-600 dark:bg-brand-950/40 dark:text-brand-400">
                        <item.icon className="h-4 w-4" />
                      </div>
                      <div>
              ...
              >
                {[
                  ...
                  >
                    <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-brand-100 text-brand-600 dark:bg-brand-950/60 dark:text-brand-400">
        ...
        <section id="planos" className="bg-muted/30 px-4 py-24 sm:px-6">
          <div className="mx-auto max-w-5xl">
            <motion.div {...fadeUp} transition={{ duration: 0.4 }} className="mb-4 text-center">
              ...
              <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-base">
                Todos os planos incluem o período de teste gratuito. Sem cartão de crédito para começar.
              </p>
            </motion.div>
        ...
        <section className="px-4 pb-24 sm:px-6">
          <div className="mx-auto max-w-4xl">
            <motion.div
              {...fadeUp}
              transition={{ duration: 0.4 }}
              className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 via-brand-600 to-brand-800 p-10 text-center text-white shadow-brand sm:p-16"
            >
              {/* Decorative glow */}
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-display mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                  Comece com um mês real.<br /> Sem compromisso.
                </h2>
                <p className="mx-auto mt-4 max-w-lg text-base text-brand-100/90">
                  Configure sua primeira escala em menos de 24 horas. Veja o time confirmar plantões antes de terminar a semana. Cancele quando quiser — sem perguntas.
                </p>
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-brand-200">
                  {['Sem cartão de crédito', 'Implementação em 24h', 'Cancele quando quiser', 'Conforme LGPD'].map(
                    (item) => (
                      <span key={item} className="flex items-center gap-1.5">
      ...
      <footer className="border-border/60 border-t px-4 py-10 sm:px-6">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-3 max-w-xs text-sm leading-relaxed">
                Plataforma de gestão de escalas e confirmação de plantões para hospitais, UPAs e clínicas.
              </p>
            </div>
          ...
          <div className="border-border/60 mt-10 flex flex-col items-center justify-between gap-3 border-t pt-6 text-sm text-muted-foreground sm:flex-row">
